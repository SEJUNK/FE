  ...
  return (
    <section ref={ref} id="fragments" className="surface-ivory story-scene archival-grain relative overflow-hidden">
      ...
      <div className="mx-auto max-w-[100rem] px-5 py-24 md:px-10 md:py-36">
        ...
        <div className="mt-20 grid gap-8 border-y border-cloud/15 py-8 md:grid-cols-4 md:items-center">
          {[
            ["Raw source records", formatCount(summary.combined.count)],
            ["Curated fragments", formatCount(receipts.length)],
            ["Discovered threads", formatCount(moments.length)],
            ["Patterns / insights", "7 exhibits"],
          ].map(([label, value], i) => (
        ...
        <p className="mt-8 max-w-xl text-sm leading-relaxed text-muted">
          The source archives are exhaustive. The story begins when carefully selected dates, places, habits and repeated details touch.
        </p>
